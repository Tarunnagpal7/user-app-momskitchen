    ...
    <LinearGradient colors={gradientColors} style={styles.container} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
      ...
      <View style={styles.content}>
        ...
        <View style={[styles.formContainer,{ backgroundColor: surfaceColor + '80', shadowColor: shadowColor }]}>
          ...
          <TextInput label="Mobile" keyboardType="number-pad" maxLength={10} value={phone} onChangeText={setPhone} style={styles.input} />
        </View>
        <TouchableOpacity style={[styles.button, { backgroundColor: primaryColor }]} onPress={handleSignup} activeOpacity={0.8} disabled={loading}>
        ...
        <TouchableOpacity style={styles.linkContainer} onPress={() => navigation.navigate('Login')}>
          <Text style={[styles.linkText, { color: subtitleColor }]}>Already have account? Login</Text>
        </TouchableOpacity>
      </View>
    </LinearGradient>
  );
