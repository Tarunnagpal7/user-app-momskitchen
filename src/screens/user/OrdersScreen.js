...
export default function OrdersScreen() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'preparing': return '#4DB6AC';
      case 'out_for_delivery': return '#81C784';
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'out_for_delivery': return 'truck-delivery-outline';
        ...
        <View style={styles.cardContent}>
          ...
          {item.status !== 'cancelled' && item.status !== 'delivered' && (
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <MaterialCommunityIcons name="close-circle-outline" size={18} color="#B00020" />
      ...
      <ScrollView style={styles.detailsContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.detailHeader}>
          <View style={styles.detailHeaderTop}>
            ...
            <View style={[styles.statusPill, { backgroundColor: getStatusColor(o.status) + '20' }]}>
              <MaterialCommunityIcons 
          ...
          <View style={styles.sectionContent}>
            ...
            {o.menu_id?.items?.map((it, idx) => (
              <View key={idx} style={styles.menuItem}>
                ...
                <Text style={[styles.menuItemType, { color: it.veg ? '#4CAF50' : '#F44336' }]}>
                  {it.veg ? 'Veg' : 'Non-Veg'}
                </Text>
              </View>
            ))}
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <MaterialCommunityIcons name="account-heart" size={20} color="#0C3415" />
        ...
        <View style={[styles.section, { marginBottom: 30 }]}>
          <View style={styles.sectionHeader}>
            <MaterialCommunityIcons name="map-marker" size={20} color="#0C3415" />
            <Text style={styles.sectionTitle}>Delivery Address</Text>
          </View>
          <View style={styles.sectionContent}>
            <Text style={styles.addressText}>{o.delivery_address?.address_line}</Text>
            ...
            <View style={styles.pincodeContainer}>
              ...
              <Text style={styles.pincodeText}>Pincode: {o.delivery_address?.pincode}</Text>
            </View>
          </View>
        </View>
      </ScrollView>
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      {loading ? (
        ...
        <View style={styles.errorContainer}>
          <MaterialCommunityIcons name="alert-circle-outline" size={60} color="#E57373" />
        ...
        <View style={styles.emptyContainer}>
          <MaterialCommunityIcons name="clipboard-text-outline" size={80} color="#e0e0e0" />
